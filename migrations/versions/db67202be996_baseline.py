...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_compute_nodes_id'), 'compute_nodes', ['id'], unique=False)
    op.create_table(
        'messages',
        sa.Column('id', sa.String(length=64), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column(
            'full_name', sa.String(length=255), nullable=True, comment="User's full display name"
        ),
        sa.Column('given_name', sa.String(length=128), nullable=True, comment='First name'),
        sa.Column('family_name', sa.String(length=128), nullable=True, comment='Last name'),
        sa.Column(
            'picture_url', sa.Text(), nullable=True, comment="URL to the user's profile picture"
        ),
        sa.Column(
            'oauth_provider',
            sa.String(length=50),
        ...
        sa.PrimaryKeyConstraint('id'),
        sa.UniqueConstraint('oauth_provider', 'provider_user_id', name='uq_user_oauth_provider_id'),
    )
    ...
    op.create_index('idx_apikey_user_id_active', 'api_keys', ['user_id', 'is_active'], unique=False)
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(['user_id'], ['users.id'], ondelete='CASCADE'),
        sa.PrimaryKeyConstraint('id'),
        sa.UniqueConstraint('user_id', 'snapshot_name', name='uq_batfish_user_snapshot_name'),
    )
    ...
    op.create_index(op.f('ix_datasets_file_id'), 'datasets', ['file_id'], unique=False)
    ...
    op.create_table(
        ...
        sa.Column(
            'truncation_strategy', sa.String(length=16), server_default='auto', nullable=True
        ),
    ...
    op.create_index(
        op.f('ix_vector_stores_deleted_at'), 'vector_stores', ['deleted_at'], unique=False
    )
    op.create_index(op.f('ix_vector_stores_id'), 'vector_stores', ['id'], unique=False)
    op.create_table(
        'actions',
        sa.Column('id', sa.String(length=64), nullable=False),
        sa.Column('run_id', sa.String(length=64), nullable=True),
    ...
    op.create_index(
        op.f('ix_actions_confidence_score'), 'actions', ['confidence_score'], unique=False
    )
    ...
    op.create_index('idx_file_storage_file_id', 'file_storage', ['file_id'], unique=False)
    op.create_table(
        'thread_participants',
        sa.Column('thread_id', sa.String(length=64), nullable=False),
        sa.Column('user_id', sa.String(length=64), nullable=False),
    ...
    op.create_index('idx_trainingjob_status', 'training_jobs', ['status'], unique=False)
    op.create_index('idx_trainingjob_user_id', 'training_jobs', ['user_id'], unique=False)
    op.create_index(
        op.f('ix_training_jobs_dataset_id'), 'training_jobs', ['dataset_id'], unique=False
    )
    op.create_index(
        op.f('ix_training_jobs_deleted_at'), 'training_jobs', ['deleted_at'], unique=False
    )
    ...
    op.create_index(op.f('ix_vector_store_files_id'), 'vector_store_files', ['id'], unique=False)
    op.create_table(
        'fine_tuned_models',
        sa.Column('id', sa.String(length=64), nullable=False),
        sa.Column('user_id', sa.String(length=64), nullable=False),
    ...
    op.create_index(
        op.f('ix_fine_tuned_models_deleted_at'), 'fine_tuned_models', ['deleted_at'], unique=False
    )
    ...
    op.create_index(
        op.f('ix_inference_deployments_id'), 'inference_deployments', ['id'], unique=False
    )
...
def downgrade() -> None:
    """Downgrade schema."""
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index(op.f('ix_inference_deployments_id'), table_name='inference_deployments')
    op.drop_table('inference_deployments')
    op.drop_table('gpu_allocations')
    op.drop_index(op.f('ix_fine_tuned_models_user_id'), table_name='fine_tuned_models')
    op.drop_index(op.f('ix_fine_tuned_models_training_job_id'), table_name='fine_tuned_models')
    op.drop_index(op.f('ix_fine_tuned_models_id'), table_name='fine_tuned_models')
    op.drop_index(op.f('ix_fine_tuned_models_deleted_at'), table_name='fine_tuned_models')
    op.drop_table('fine_tuned_models')
    op.drop_index(op.f('ix_vector_store_files_id'), table_name='vector_store_files')
    ...
    op.drop_index(op.f('ix_training_jobs_deleted_at'), table_name='training_jobs')
    op.drop_index(op.f('ix_training_jobs_dataset_id'), table_name='training_jobs')
    op.drop_index('idx_trainingjob_user_id', table_name='training_jobs')
    op.drop_index('idx_trainingjob_status', table_name='training_jobs')
    op.drop_table('training_jobs')
    op.drop_table('thread_participants')
    op.drop_index('idx_file_storage_file_id', table_name='file_storage')
    ...
    op.drop_index(op.f('ix_datasets_file_id'), table_name='datasets')
    ...
    op.drop_index('idx_apikey_user_id_active', table_name='api_keys')
    ...
    op.drop_index(op.f('ix_compute_nodes_id'), table_name='compute_nodes')
