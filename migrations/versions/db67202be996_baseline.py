...
def downgrade() -> None:
    ...
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index(
        op.f("ix_inference_deployments_id"), table_name="inference_deployments"
    )
    ...
    op.drop_index(
        op.f("ix_fine_tuned_models_training_job_id"), table_name="fine_tuned_models"
    )
    op.drop_index(op.f("ix_fine_tuned_models_id"), table_name="fine_tuned_models")
    op.drop_index(
        op.f("ix_fine_tuned_models_deleted_at"), table_name="fine_tuned_models"
    )
