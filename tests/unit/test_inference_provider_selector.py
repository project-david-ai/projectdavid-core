...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("vllm/Qwen/Qwen2.5-VL-3B-Instruct-AWQ", "vllm/"),
        ("vllm/bm_XoSgMaQbOSuPnVXZ3gcQF6", "vllm/"),
        ("vllm/ftm_exampleAdapterId", "vllm/"),
        # Case insensitive
...
@pytest.mark.parametrize(
    ...
    [
        ...
        "bm_XoSgMaQbOSuPnVXZ3gcQF6",
        "ftm_exampleAdapterId",
        "",
        "no-slash-at-all",
    ],
)
